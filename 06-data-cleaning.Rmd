...
#loading the data, as described in the Overview section
#sce.zeisel <- ZeiselBrainData()
#sce.zeisel <- aggregateAcrossFeatures(sce.zeisel, 
    id=sub("_loc[0-9]+$", "", rownames(sce.zeisel)))

#plotting the four data quality measures
gridExtra::grid.arrange(
    plotColData(sce.zeisel, y = "sum") + scale_y_log10() + ggtitle("Total count"),
    plotColData(sce.zeisel, y = "detected") + scale_y_log10() + ggtitle("Detected features"),
...
#here we plot the distributions again, but now we are coloring the samples that will be removed in orange
gridExtra::grid.arrange(
