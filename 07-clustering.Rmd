...
nn.clusters <- clusterCells(sce.zeisel.PCA.1000, use.dimred="PCA")
str(sce.zeisel.PCA.1000)
...
colLabels(sce.zeisel.PCA.1000) <- nn.clusters
plotReducedDim(sce.zeisel.PCA.1000, "PCA", colour_by="label")
```
